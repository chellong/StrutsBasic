...
<body>
	<ol>
		...
		<li>bean 定义bean,并使用param来设定新的属性值: 
			<s:bean name="com.example.struts2.tags.Dog">
		...
		<li>bean 查看debug情况: <s:bean name="com.example.struts2.tags.Dog"
				var="myDog">
		...
		<li>include _include1.html 包含静态英文文件 <s:include 
				value="/Html/_include1.html"></s:include>
		</li>

		<li>include _include2.html 包含静态中文文件 <s:include
				value="/Html/_include2.html"></s:include>
		</li>

		<li>include _include1.html 包含静态英文文件，说明%用法 <s:set var="incPage"
				value="%{'/Html/_include1.html'}" /> <s:include value="%{#incPage}"></s:include>
		</li>
